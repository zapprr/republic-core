...
Citizen.CreateThread(function()
	...
	TriggerEvent('chat:addSuggestion', '/gme', 'Indicate that your character is doing something to all players.', {{ name="message", help="The thing that your character is doing."}})
	TriggerEvent('chat:addSuggestion', '/my', 'Indicate that something belonging to your character is doing something to nearby players.', {{ name="message", help="The thing that belongs to your character, and what it's doing."}})
	TriggerEvent('chat:addSuggestion', '/gmy', 'Indicate that something belonging to your character is doing something to all players.', {{ name="message", help="The thing that belongs to your character, and what it's doing."}})
	TriggerEvent('chat:addSuggestion', '/me', 'Indicate that your character is doing something to nearby players.', {{ name="message", help="The thing that your character is doing."}})
	...
	TriggerEvent('chat:addSuggestion', '/search', 'Search something.', {{ name="name", help="What you're searching (examples include \"John Doe\", \"The Red Stanier\", etc)."}})
