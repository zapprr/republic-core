-- This lists the vehicle classes that only members can drive. https://docs.fivem.net/natives/?_0x29439776AAA00A62
memberOnlyVehicles = {
	18, 
	16, 
	15, 
	...
	-- Vehicles blacklisted because they serve a small niche in roleplay but are abused outside of that
	"dune2",
	"speedo2",
	"veto", 
	"veto2",
	...
	-- Vehicles blacklisted due to being armoured/armed
	"kosatka",
	"zhaba",
	"boxville5",
	"technical",
	...
	-- Vehicles blacklisted due to their rarity/expensiveness
	"bestiagts",
	"coquette4",
	"corsita",
	"carbonizzare",
...
-- This lists weapons which guests are blacklisted from using.
memberOnlyWeapons = {
	...
	'WEAPON_BEANBAG',
	'WEAPON_40MMLESSLETHAL',
	'WEAPON_40MMLESSLETHAL2',
	'WEAPON_COMBATSHOTGUN',
	'WEAPON_MILITARYCARBINE',
	'WEAPON_MILITARYRIFLE',
	'WEAPON_militiarifle',
	'WEAPON_VFCLASSICRIFLE',
	'WEAPON_HL_NAVYCARBINE',
	'WEAPON_NAVYCARBINE',
	'WEAPON_combatrifle',
	'WEAPON_stealthcarbine',
	"weapon_modularcarbine",
	"weapon_stampedrifle",
	"weapon_amrifle",
	"weapon_protorifle",
    "weapon_rapidfiresmg",
...
-- This lists vehicles which are completely blacklisted - all instances of these vehicles will get immediately deleted.
blacklistedVehicles = {
	"scarab2",
	"scarab3",
	"ruiner2",
